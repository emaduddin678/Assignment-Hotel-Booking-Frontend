...
const Hotel = () => {
  ...
  // useEffect(() => {
  //   console.log("Hello")
  //   // console.log("Inside useEffect - dates:", dates);
  //   // if (dates) {
  //   //   console.log("Setting mydates:", dates);
  //   //   setMydates(dates);
  //   // }
  // }, []);
  console.log(dates);
        ...
        <div className="hotelContainer">
          ...
          <div className="hotelWrapper">
            ...
            <span className="hotelPriceHighlight">
              Book a stay over BDT {data.cheapestPrice} Taka at this property
            ...
            <div className="hotelDetails">
              ...
              <div className="hotelDetailsPrice">
                ...
                <h2>
                  ...
                  <b>BDT. {days * data.cheapestPrice * options.room}</b> ({days}{" "}
                  nights)
                </h2>
